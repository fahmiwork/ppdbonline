...
$page = 'pengumuman'; include './template_admin/sidebar_siswa.php';
?>
...
?>
										<table id="basic-datatables" class="isplay table table-striped table-bordered table-hover" >
											...
											include 'database/koneksi.php';
												...
												$data = mysqli_query($koneksi, "SELECT * FROM tb_pendaftar WHERE status_pendaftaran='Diterima'")or die(mysqli_error());
												$nomor = 1;
