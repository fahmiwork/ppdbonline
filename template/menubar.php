      ...
      <div class="row">
        <div class="col-sm text-center text-md-left mb-md-0 mb-2 pr-md-4 d-flex topper align-items-center">
          <p class="mb-0 w-100">
            ...
            <span class="text">mi@gmail.com</span>
          </p>
        </div>
      ...
      <div class="row d-flex align-items-start align-items-center px-3 px-md-0">
        <div class="col-md-4 d-flex mb-2 mb-md-0">
          <a class="navbar-brand d-flex align-items-center" href="index.html">
            <img src="./assets/images/sc.jpg" style="height: 40px; margin-top: 5px; margin-left:5px;" width="40px" height="50px">
            <span class="ml-2"><small>PPDB Online</small>MI AL-MUHAJIRIN</span>
          </a>
        </div>
        ...
        <div class="col-md-4 d-flex topper mb-md-0 align-items-center">
          ...
          <div class="text pl-3 pl-md-3">
            <p class="hr"><span>Alamat </span></p>
            <p class="con">Jl. Bawal No. 35 A BatuMerah - Kota Batam (29457)</p>
          </div>
        </div>
      </div>
    </div>
