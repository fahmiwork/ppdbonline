...
$page= 'login'; include 'template_user/menubar.php';
?>
...
if(isset($_GET['pesan'])){
	$pesan = $_GET['pesan'];
	if($pesan == "input"){
		echo '<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Anda berhasil mendaftar akun, silahkan login!.</div>';
...
?>
                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    <form action="akun/aksi_login.php" method="post">
