...
?>
										<table id="basic-datatables" class="isplay table table-striped table-bordered table-hover" >
											...
											?>
												  ...
												  <td style='text-align:center;'><a class="btn btn-primary btn-sm" href="detail_pendaftar.php?id_pendaftar=<?php echo $d['id_pendaftar'];?>"><i class="far fa-info"> Detail</i></a> 
												  | <a class="btn btn-success btn-sm" href="data_excel_id.php?id_pendaftar=<?php echo $d['id_pendaftar'];?>"><i class="far fa-print"> Cetak excel</i></a>
												  | <a class="btn btn-info btn-sm" href="print_data.php?id_pendaftar=<?php echo $d['id_pendaftar'];?>" target="_blank"><i class="far fa-print"> Cetak pdf</i></a>
												  | <a class="btn btn-danger btn-sm" href="./pendaftaran/delete_pendaftar.php?id_pendaftar=<?php echo $d['id_pendaftar'];?>"><i class="far fa-window-close"> Hapus</i></a></td>
										...
										<a href='export_pendaftaran.php' class='btn btn-success btn-sm'><i class='fa fa-print'> Cetak Excel</i></a>
									</div>
								</div>
							</div>
						</div>
