    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="login_adm.php">Login Admin</a></li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/images/sc.jpg" alt="" />
                <!-- Masthead Heading-->
                ...
                <p class="masthead-subheading font-weight-light mb-0"> <?php
                                ...
                                ?>
                                    <?= $data['nama_sekolah']; ?>
                                <?php } ?></p>
            </div><h3><a class="btn btn-warning btn-sm" href="login_user.php"> <b>Login</b></a></h3>
        </header>
        <!-- Portfolio Section-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="panduan">
            <div class="container">
                ...
                <div class="text-center mt-4">
                    <a class="btn btn-xl btn-outline-light" href="mendaftar_akun.php">
                        Daftar
                    </a>
                </div>
            </div>
        ...
        <!-- Contact form JS-->
        <script src="assets3/mail/jqBootstrapValidation.js"></script>
        <script src="assets3/mail/contact_me.js"></script>
        <!-- Core theme JS-->
